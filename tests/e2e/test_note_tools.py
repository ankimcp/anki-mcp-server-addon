...
class TestNoteTools:
    ...
    def test_find_notes_empty_query(self):
        """find_notes with empty collection should return empty list."""
        result = call_tool("find_notes", {"query": "deck:*"})
        assert "noteIds" in result

    def test_find_notes_with_limit(self):
        """find_notes should respect limit parameter."""
    ...
    def test_find_notes_invalid_limit(self):
        """find_notes with invalid limit should return error."""
        result = call_tool("find_notes", {"query": "deck:*", "limit": "-1"})
